...
Tray::Tray(const String &friendlyName, int ID, HomeAssistant &connection, Display &display, int motorPin1, int motorPin2, int speedPin) : Output(friendlyName, ID, connection, display), m_motorPin1(motorPin1), m_motorPin2(motorPin2), m_speedPin(speedPin) {}
