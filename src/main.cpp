...
ConnectedTemperatureVariableLight sofaLight("Lampe du canapé", ID_SOFA_LIGHT, HomeAssistantConnection, display, 2000, 6000); // Changer les températures.
ConnectedColorVariableLight bedLight("Lampe de chevet", ID_BED_LIGHT, HomeAssistantConnection, display, 2000, 5000); // Changer les températures.
